...
import com.epam.pipeline.entity.cluster.AwsRegionsConfiguration;
...
public class SystemPreferences {
    ...
    private static final TypeReference<Map<String, Object>> SIMPLE_OBJECT_TYPE_REFERENCE =
    ...
    // DATA_STORAGE_GROUP
    public static final BooleanPreference DATA_STORAGE_POLICY_BACKUP_ENABLED = new BooleanPreference(
        "storage.policy.backup.enabled", true, DATA_STORAGE_GROUP, pass);
    ...
    public static final ObjectPreference<Map<String, Object>> DATA_STORAGE_POLICY = new ObjectPreference<>(
        "storage.policy", null, SIMPLE_OBJECT_TYPE_REFERENCE, DATA_STORAGE_GROUP,
        isNullOrValidJson(SIMPLE_OBJECT_TYPE_REFERENCE));
    public static final StringPreference DATA_STORAGE_TEMP_CREDENTIALS_ROLE = new StringPreference(
        "storage.temp.credentials.role", null, DATA_STORAGE_GROUP, PreferenceValidators.isAwsRoleValid);
    public static final IntPreference DATA_STORAGE_POLICY_BACKUP_DURATION = new IntPreference(
        "storage.policy.backup.duration", 20, DATA_STORAGE_GROUP, isGreaterThanOrEquals(0));
    ...
    public static final StringPreference DATA_STORAGE_SECURITY_KEY_ID = new StringPreference(
        "storage.security.key.id", null, DATA_STORAGE_GROUP, PreferenceValidators.isValidKMSKeyId);
    public static final StringPreference DATA_STORAGE_SECURITY_KEY_ARN = new StringPreference(
        "storage.security.key.arn", null, DATA_STORAGE_GROUP, PreferenceValidators.isValidKMSKeyARN);
    public static final ObjectPreference<Map<String, Object>> DATA_STORAGE_CORS_POLICY = new ObjectPreference<>(
        "storage.cors.policy", null, SIMPLE_OBJECT_TYPE_REFERENCE, DATA_STORAGE_GROUP, pass);
    ...
    public static final IntPreference CLUSTER_INSTANCE_HDD = new IntPreference("cluster.instance.hdd", 10,
                                                                               CLUSTER_GROUP, isGreaterThan(0));
    public static final ObjectPreference<AwsRegionsConfiguration> CLUSTER_NETWORKS_CONFIG =
        new ObjectPreference<>("cluster.networks.config", null, new TypeReference<AwsRegionsConfiguration>() {},
                               CLUSTER_GROUP, isNullOrValidJson(new TypeReference<AwsRegionsConfiguration>() {}));
    /**
    ...
    public static final BooleanPreference CLUSTER_SPOT = new BooleanPreference("cluster.spot", true, CLUSTER_GROUP,
                                                                               pass);
    public static final StringPreference CLUSTER_SSH_KEY_NAME = new StringPreference("cluster.ssh.key.name", null,
                                                                     CLUSTER_GROUP, PreferenceValidators.isValidKey);
    public static final StringPreference CLUSTER_INSTANCE_IMAGE = new StringPreference("cluster.instance.image", null,
                                                                   CLUSTER_GROUP, PreferenceValidators.isValidImage);
