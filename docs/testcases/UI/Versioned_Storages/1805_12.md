...
| 4 | Click **Delete** icon next to the `file1` in the storage | ***Remove file*** pop-up appears that contains <li> Confirmation message `Are you sure you want to delete file 'file1'?` </li><li> Field for the input commit message |
