  ...
  render() {
    const modalFooter = this.props.pending ? (
      ...
      <Row type="flex" justify="space-between">
        <Button id="commit-pipeline-run-form-cancel-button" onClick={this.props.onCancel}>
          CANCEL
        </Button>
        {this.registries.length && (
          <Button
            ...
            type="primary"
            htmlType="submit"
            disabled={!this.toolValid || !this.layersCheckPassed || !this.commitCheckPassed}
