...
public class KubernetesManager {
    ...
    private void modifyNodeLabel(String nodeName, String labelName, Consumer<Map<String, String>> actionOnLabel) {
        if (!StringUtils.hasText(nodeName) || !StringUtils.hasText(labelName)) {
            return;
        }
        try(KubernetesClient client = getKubernetesClient()) {
    ...
    public void waitForNodeReady(String nodeName, String runId, String awsRegion) throws InterruptedException {
        ...
        addNodeLabel(nodeName, KubernetesConstants.AWS_REGION_LABEL, awsRegion);
    }
        ...
        final String portLabelValue = getValueFromLabelsOrDefault(service.getMetadata().getLabels(),
                ...
                final Integer port = ListUtils.emptyIfNull(service.getSpec().getPorts())
                        ...
                        .orElseThrow(() -> new IllegalArgumentException(
                                messageHelper.getMessage(MessageConstants.ERROR_KUBE_SERVICE_PORT_UNDEFINED,
    ...
    private String getValueFromLabelsOrDefault(final Map<String, String> labels,
        ...
        if (!StringUtils.hasText(labelName) || !StringUtils.hasText(MapUtils.emptyIfNull(labels).get(labelName))) {
