...
export default function preview(props) {
  ...
  switch (props.item.type) {
    ...
    case SearchItemTypes.configuration:
      Content = ConfigurationPreview;
      break;
    case SearchItemTypes.dockerRegistry:
      Content = DockerRegistryPreview;
      break;
    case SearchItemTypes.toolGroup:
      Content = ToolGroupPreview;
      break;
    case SearchItemTypes.metadataEntity:
      Content = MetadataEntityPreview;
      break;
