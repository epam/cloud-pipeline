...
export default {
  ...
  configuration: {
    ...
    '@input-shadow-color': 'rgba(180, 188, 196, 0.05)',
    '@input-search-icon-color': 'rgba(180, 188, 196, 0.3)',
    '@input-search-icon-hovered-color': 'rgba(180, 188, 196, 0.6)',
    '@card-background-color': 'rgb(23, 27, 33)',
    '@card-border-color': 'rgb(41, 46, 54)',
    ...
    '@navigation-panel-highlighted-color': '@panel-background-color',
