...
export default {
  ...
  [Panels.userCosts]: 'This widget display summary spendings during the current calendar month and year (from the 1st day of the month till yesterday in case of month, from the 1 Jan till yesterday in case of year) and summary spending during the previous calendar month and year for the same period.'
};
