...
public class RunPipelineWithOutputParameterTest extends AbstractAutoRemovingPipelineRunningTest implements StorageHandling {
    ...
    @Test
    @TestCase({"EPMCMBIBPC-917"})
    public void runPipelineWithOutputParameter() {
        navigationMenu()
