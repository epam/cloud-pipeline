...
/**
 * Overrides {@link NetworkRequester} class to support network usage statistics for particular pod.
 */
public class PodNetworkRequester extends NetworkRequester {

    PodNetworkRequester(HeapsterElasticRestHighLevelClient client) {
        super(client);
    }

    @Override
    protected ELKUsageMetric metric() {
        return ELKUsageMetric.POD_NETWORK;
    }
