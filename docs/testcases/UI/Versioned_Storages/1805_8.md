...
| 5 | In OS dialog, select `test_file_more_75kb.txt`, `test_file_less_250b.txt`, `CD8.jpg` files (see files in the folder of the test case)
| 6 | Confirm the upload | New files appears in the storage. |
| 7 | Click the tile of the `test_file_more_75kb.txt` file in the list | <li> Value of file size in column ***Size*** is more than 75kb. </li><li> At the right side, the "Information" panel appears that contains: <ul><li> Message `File preview is not available. Download file to view full contents` with link to download file </li><li> Commit history of the current file (Revision, Author, Date, Commit message) |
| 8 | Repeat step 7 for `CD8.jpg` | At the right side, the "Information" panel appears that contains: <li> Message `File preview is not available. Download file to view full contents` with link to download file </li><li> Commit history of the current file (Revision, Author, Date, Commit message) |
| 9 | Click `Download file` link | The file `CD8.jpg` is downloaded to the local storage and equal to the file from step 5 |
| 10 | Click the tile of the `test_file_less_250b.txt` file in the list |  <li> Value of file size in column ***Size*** is less than 250b. </li><li> At the right side, the "Information" panel appears that contains: <ul><li>  File preview </li><li> the button to edit file content </li><li>  commit history of the current file (Revision, Author, Date, Commit message) |
...
| 16 | Click ***<>*** icon near the commit to see differences | ***Difference for \<commit\>*** pop-up appears that contains <li> differences for `test_file_less_250b.txt` with tag `CHANGED` |