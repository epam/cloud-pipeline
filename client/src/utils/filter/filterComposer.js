...
const parser = (function () {
  const parser = {
    ...
    performAction: function anonymous(
      ...
      switch (yystate) {
        ...
        case 4:
          ...
          break;
        case 5:
          this.$ = new yy.IncompleteLogicalExpression(undefined, undefined, undefined, {
            total: this._$,
          });
          break;
        case 6:
          ...
          break;
        case 7:
          this.$ = new yy.LogicalExpression($$[$0 - 3], $$[$0 - 2], $$[$0 - 1], {
            property: _$[$0 - 3],
            operand: _$[$0 - 2],
            value: _$[$0 - 1],
            total: this._$,
          ...
          break;
        case 8:
          this.$ = new yy.IncompleteLogicalExpression($$[$0], undefined, undefined, {
            property: _$[$0],
            total: this._$,
          });
          break;
    ...
    table: [
      {3: 1, 4: 2, 5: [2, 5], 6: 3, 7: [2, 5], 8: [2, 5], 9: [1, 4], 12: 5, 13: [1, 6], 14: [1, 7]},
      {1: [3]},
      {5: [1, 8], 7: [1, 9], 8: [1, 10]},
      {5: [2, 2], 7: [2, 2], 8: [2, 2]},
      {5: [2, 8], 7: [2, 8], 8: [2, 8], 10: [1, 11]},
      {5: [2, 9], 7: [2, 9], 8: [2, 9], 9: [1, 12], 13: [1, 13], 14: [1, 14]},
      {5: [2, 13], 7: [2, 13], 8: [2, 13], 9: [2, 13], 13: [2, 13], 14: [2, 13]},
      {5: [2, 15], 7: [2, 15], 8: [2, 15], 9: [2, 15], 13: [2, 15], 14: [2, 15]},
      {1: [2, 1]},
      {4: 15, 5: [2, 5], 6: 3, 7: [2, 5], 8: [2, 5], 9: [1, 4], 12: 5, 13: [1, 6], 14: [1, 7]},
      {4: 16, 5: [2, 5], 6: 3, 7: [2, 5], 8: [2, 5], 9: [1, 4], 12: 5, 13: [1, 6], 14: [1, 7]},
      {
        5: [2, 17],
        7: [2, 17],
        8: [2, 17],
      ...
      {5: [2, 11], 7: [2, 11], 8: [2, 11], 10: [1, 20]},
      {5: [2, 14], 7: [2, 14], 8: [2, 14], 9: [2, 14], 13: [2, 14], 14: [2, 14]},
      {5: [2, 16], 7: [2, 16], 8: [2, 16], 9: [2, 16], 13: [2, 16], 14: [2, 16]},
      {5: [2, 3], 7: [2, 3], 8: [1, 10]},
      {5: [2, 4], 7: [2, 4], 8: [2, 4]},
      {5: [2, 6], 7: [2, 6], 8: [2, 6], 12: 21, 13: [1, 6], 14: [1, 7]},
      {5: [2, 18], 7: [2, 18], 8: [2, 18], 13: [2, 18], 14: [2, 18]},
      {5: [2, 19], 7: [2, 19], 8: [2, 19], 13: [2, 19], 14: [2, 19]},
      {
        5: [2, 17],
        7: [2, 17],
        8: [2, 17],
      ...
      {5: [2, 7], 7: [2, 7], 8: [2, 7], 13: [1, 13], 14: [1, 14]},
      {5: [2, 10], 7: [2, 10], 8: [2, 10], 12: 23, 13: [1, 6], 14: [1, 7]},
      {5: [2, 12], 7: [2, 12], 8: [2, 12], 13: [1, 13], 14: [1, 14]},
    ],
