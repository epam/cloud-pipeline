...
function DataStorageLink({children, className, isFolder, dataStorages, path, storageId, style}) {
  const {storageId: parsedStorageId, folderPath: parsedPath} = getStorageLinkInfo({
