...
export default class EditToolGroupForm extends React.Component {
  ...
  render() {
    const {toolGroup, authenticatedUserInfo} = this.props;
    const isPersonal =
      toolGroup && toolGroup.privateGroup && roleModel.isOwner(this.props.toolGroup);
    const isAdmin =
    ...
    return (
      <Modal
        ...
        title={isNewToolGroup ? 'Create group' : 'Edit group'}
