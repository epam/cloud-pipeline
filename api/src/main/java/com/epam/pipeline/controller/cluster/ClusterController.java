...
public class ClusterController extends AbstractRestController {
    ...
    @ApiOperation(
            ...
            notes = "Returns all instance types.",
            produces = MediaType.APPLICATION_JSON_VALUE
        )
    @ApiResponses(
            value = {@ApiResponse(code = HTTP_STATUS_OK, message = API_STATUS_DESCRIPTION)
    ...
    public Result<List<InstanceType>> loadAllInstanceTypes(
            @RequestParam(required = false, defaultValue = "false") boolean toolInstances) {
        return toolInstances
            ? Result.success(clusterApiService.getAllowedToolInstanceTypes())
            : Result.success(clusterApiService.getAllowedInstanceTypes());
    }
    ...
    public Result<AllowedInstanceAndPriceTypes> loadAllowedInstanceAndPriceTypes(
            @RequestParam(required = false) final String toolId) {
        return Result.success(clusterApiService.getAllowedInstanceAndPriceTypes(toolId));
    }
