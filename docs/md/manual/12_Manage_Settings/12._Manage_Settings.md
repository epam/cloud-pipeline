...
| Control | Description |
|---|---|
| **Search field** | To search particular user from a list of users, start to enter the user's name (see the picture above, **1**). |
| **Show users** | This control (see the picture above, **2**) allows to select which users to show - all (_by default_), only unblocked ones, only blocked ones. More details about blocking/unblocking see [here](../../release_notes/v.0.16/v.0.16_-_Release_notes.md#blockingunblocking-users-and-groups). |
| **+ Create user** | This control (see the picture above, **3**) opens a **"Create user"** form, which can be used to create a new user. More details see [here](12.3._Create_a_new_user.md). |
| **Import users** | Allows to import users from the list in `.csv` format (see the picture above, **4**). |
| **Export users** | Allows export all users with selected set of attributes (see the picture above, **5**). More details see below. |
| **Edit** | Allows changing a list of roles or groups assigned to a user (see the picture above, **6**). More details see [here](12.4._Edit_delete_a_user.md#edit-a-user). |
...
| **+ Create group** | Create a new group (see the picture above, **2**). More details see [here](12.5._Create_a_group.md). |
| **Edit** | This control (see the picture above, **3**) allows changing a list of users owning this group. More details see [here](12.6._Edit_a_group_role.md#edit-a-group-role). |
| **Delete** | Delete a group (see the picture above, **4**). More details see [here](12.7._Delete_a_group.md). |
