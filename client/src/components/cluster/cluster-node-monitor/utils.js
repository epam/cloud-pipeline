...
function extractTimelineData({metrics = {}, measure, hideDatasets = [], from, to}) {
...
function extractHeatmapData({metrics = {}, measure, from, to, hideDatasets = []}) {
  const extractHeatMapDataByKey = (metrics, key, measure = 'average', mapValue = (v) => v) => {
