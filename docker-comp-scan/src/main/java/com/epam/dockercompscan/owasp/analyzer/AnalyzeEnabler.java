...
public enum AnalyzeEnabler {
    ...
    ANALYZER_ARCHIVE("analyzer.archive.enabled", "System"),
    ...
    ANALYZER_AUTOCONF("analyzer.autoconf.enabled", "System"),
    ...
    ANALYZER_ASSEMBLY("analyzer.assembly.enabled", "System"),
    ANALYZER_BUNDLE_AUDIT("analyzer.bundle.audit.enabled", RubyBundleAuditAnalyzer.DEPENDENCY_ECOSYSTEM),
    ANALYZER_OPENSSL("analyzer.openssl.enabled", "System"),
    ...
    ANALYZER_CENTRAL("analyzer.central.enabled", "System"),
    ANALYZER_NEXUS("analyzer.nexus.enabled", "System"),
