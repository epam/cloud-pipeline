...
public class PrefixQueryBuilderV7 implements PrefixQueryBuilder {
    ...
    private final shaded.org.elasticsearch.v7.index.query.PrefixQueryBuilder inner;

    public PrefixQueryBuilderV7(final String name, final String prefix) {
        inner = shaded.org.elasticsearch.v7.index.query.QueryBuilders.prefixQuery(name, prefix);
    }
}
