...
| 6 | Open the storage  from the [_2182\_2_](2182_2.md) Prerequisites | Storage page opens and contains: <li> Storage size is 2.5 Gb <li> ***Warning*** icon is displayed. <li> *Storage status is: MOUNT IS READ-ONLY* is shown on the ***Warning*** icon tooltip <li> **Create** and **Upload** buttons are shown |
