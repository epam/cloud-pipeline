...
| **ROLE\_STORAGE\_READER** | the user gets Read permission to all data storages in the system. See details [here](../13_Permissions/13._Permissions.md#storage-reader-role). |
...
For more details see [here](12.12._SystemLogs.md).
