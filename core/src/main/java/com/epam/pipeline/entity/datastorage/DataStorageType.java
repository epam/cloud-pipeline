...
public enum DataStorageType {
    ...
    AWS_OMICS_REF("AWS_OMICS_REF", StorageServiceType.AWS_OMICS_REF, Collections.singleton(Constants.STANDARD_STORAGE_CLASS)),
    AWS_OMICS_SEQ("AWS_OMICS_SEQ", StorageServiceType.AWS_OMICS_SEQ, Collections.singleton(Constants.STANDARD_STORAGE_CLASS));
