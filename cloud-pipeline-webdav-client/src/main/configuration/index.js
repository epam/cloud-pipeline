...
const readConfiguration = require('./utilities/read-configuration');
const readGlobalConfiguration = require('./utilities/export-from-pipe-cli');
...
const printConfiguration = require('./utilities/print-configuration');
