...
class TestNoMachineEndpoints(object):
    ...
    run_id = None
    node = None
    pipeline_name = 'test_nomachine_endpoints_ubuntu'
    ...
    def test_nomachine_endpoint_on_ubuntu_16_image(self):
        run_id, node_name = utils.run_pipeline(self.pipeline_name,
                                               "cp-docker-registry.default.svc.cluster.local:31443/library/ubuntu:16",
    ...
    def test_nomachine_endpoint_on_ubuntu_18_image(self):
        run_id, node_name = utils.run_pipeline(self.pipeline_name,
                                               "cp-docker-registry.default.svc.cluster.local:31443/library/ubuntu:18",
                                               "CP_CAP_LIMIT_MOUNTS 'None' CP_CAP_DESKTOP_NM 'boolean?true'")
        self.run_id = run_id
        self.node = node_name
        urls = get_endpoint_urls(run_id)
