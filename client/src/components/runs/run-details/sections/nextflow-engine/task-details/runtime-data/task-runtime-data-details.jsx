...
class TaskRuntimeDataDetails extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      const clear =
        runId !== prevRunId || taskKey !== prevTaskKey || detailsType !== prevDetailsType;
      ...
      return (
        <div className={classNames(className)} style={style}>
          <div className={styles.runtimeDataStateContainer}>
            <div className="cp-text-not-important" style={{display: 'flex', alignItems: 'center'}}>
              <LoadingOutlined />
        ...
        <div className={classNames(className)} style={style}>
          <div className={styles.runtimeDataStateContainer}>
            <div style={{display: 'flex', alignItems: 'center'}}>
              <Alert type="warning" title={completed ? errorMessage : errorMessageRunning} />
            </div>
          </div>
        </div>
      ) : null;
...
const TaskRuntimeDataDetailsProps = {
  ...
  detailsType: PropTypes.oneOf(['exit', 'log', 'out', 'err', 'trace', 'command', 'run', 'begin']),
