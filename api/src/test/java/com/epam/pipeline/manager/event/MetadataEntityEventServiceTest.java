...
public class MetadataEntityEventServiceTest extends AbstractSpringTest {

    @Autowired
    private MetadataEntityEventService metadataEntityEventService;
    ...
    public void shouldAddMetadataEntityEvent() {
        ...
        metadataEntityEventService.updateEventsWithChildrenAndIssues(1L);
