...
openssl x509 -pubkey -noout -in $CP_API_SRV_CERT_DIR/jwt.key.x509  > $CP_GITLAB_READER_HOME/gitreader/pub-jwt-key.pem
export CP_API_JWT_PUB_KEY=$CP_GITLAB_READER_HOME/gitreader/pub-jwt-key.pem
