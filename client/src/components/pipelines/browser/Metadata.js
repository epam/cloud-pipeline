  ...
  renderFilterButton = (key) => {
    ...
    const button = (
      <Button
        ...
        className={this.filterApplied(key) ? 'cp-library-metadata-icon-blue' : 'cp-library-metadata-icon-grey'}
        style={{
          marginLeft: 5,
          border: 'none'
        }}
    ...
    const renderSelectionControl = () => {
      ...
      if (
        ...
        menuItems.push((
          <MenuItem
            key={Actions.delete}
            className={classNames(styles.menuItem, Actions.delete, 'cp-library-metadata-icon-red')}
          >
            Delete
          </MenuItem>
        ));
