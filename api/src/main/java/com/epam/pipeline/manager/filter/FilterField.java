...
import com.epam.pipeline.manager.filter.composers.DefaultComposer;
import com.epam.pipeline.manager.filter.composers.AbstractFilterComposer;
import com.epam.pipeline.manager.filter.converters.DefaultConverter;
import com.epam.pipeline.manager.filter.converters.AbstractFilterValueConverter;
