  ...
  class SummaryWrappedComponent extends React.Component {
    ...
    render() {
      ...
      if (
        ...
        Object.hasOwn(wrappedComponentStyle, 'height') &&
      ...
      return (
        <div>
          <Radio.Group
            ...
            size="small"
          >
            <Radio.Button key={Display.accumulative} value={Display.accumulative}>
              Accumulative
            </Radio.Button>
            <Radio.Button key={Display.fact} value={Display.fact}>
              Fact
            </Radio.Button>
          </Radio.Group>
          <WrappedComponent display={display} {...wrappedProps} />
        </div>
      );
    }
  }
