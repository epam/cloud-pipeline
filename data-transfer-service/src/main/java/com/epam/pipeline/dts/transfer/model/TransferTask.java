...
public class TransferTask {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "transfer_task_generator")
    @SequenceGenerator(name = "transfer_task_generator", sequenceName = "s_transfer_task", allocationSize = 1)
    private Long id;
