...
class RunLaunchCommandSection extends React.Component {
  ...
  renderCliContent = () => {
    const {linuxCode, windowsCode, pending} = this.props;
  ...
  renderApiContent = () => {
    const {runPayload, pending} = this.props;
  ...
  render() {
    ...
    const {tab} = this.state;
    return (
      <div className={classNames(className, styles.runLaunchCommandSection)} style={style}>
        <div
