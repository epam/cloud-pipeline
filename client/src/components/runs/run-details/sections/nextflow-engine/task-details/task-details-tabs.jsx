...
function TaskDetailsTabs(props) {
  const {className, style, tabs, activeTabKey, onChangeActiveTabKey} = props;
  const onChange = ({key}) => (onChangeActiveTabKey ? onChangeActiveTabKey(key) : undefined);
  return (
    <div className={classNames(className, styles.runDetailsTabs)} style={style}>
      <Menu
