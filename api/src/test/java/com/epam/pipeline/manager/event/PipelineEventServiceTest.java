...
public class PipelineEventServiceTest extends AbstractSpringTest {
    ...
    public void shouldAddPipelineEvent() {
        ...
        pipelineEventService.updateEventsWithChildrenAndIssues(1L);
