...
function SectionData({children, className, style}) {
  return (
    <table className={classNames(className, styles.sampleSheetSectionData)} style={style}>
...
function SectionDataRow({className, data, style}) {
  if (!data) {
    return null;
  }
