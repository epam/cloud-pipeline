...
from cpaibot.common.model.chat import ChatElementBaseModel
...
def _success(payload):
    def f(obj):
        return obj.to_json() if isinstance(obj, ChatElementBaseModel) else obj
    if isinstance(payload, list):
        payload = [f(o) for o in payload]
    return {
        'payload': f(payload),
        'status': 'OK'
    }
