...
import ShareWithForm, {
  ROLE_ALL,
  shouldCombineRoles
} from './logs/forms/ShareWithForm';
...
export default class ShareWith extends React.Component {
  ...
  get combineRolesIntoAllRoles () {
    ...
    return {
      ...
      endpoint: shouldCombineRoles(
        runSids,
        ROLE_ALL.includedRoles,
  ...
  get shareList () {
    ...
    const {ssh: combineSshRoles, endpoint: combineEndpointRoles} =
