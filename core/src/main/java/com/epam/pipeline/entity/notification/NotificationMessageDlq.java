...
@EqualsAndHashCode
@Entity
@Table(name = "notification_queue_dlq", schema = "pipeline")
public class NotificationMessageDlq {
    @Id
    ...
    @Convert(converter = NotificationMessageDlq.UserIdsConverter.class)
    @Column(name = "user_ids")
    private List<Long> copyUserIds;

    @Column(name = "template_parameters")
    @Convert(converter = NotificationMessageDlq.ParameterConverterJson.class)
