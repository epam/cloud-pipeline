...
4. **Launch tool** page will be open.  
...
In this example, we will run the "**base-gui-centos-nomachine**" Tool with custom settings: **20 Gb** hard drive, **2 CPU** cores, and **8 Gb** RAM. Pricing is calculated for a spot instance.  
