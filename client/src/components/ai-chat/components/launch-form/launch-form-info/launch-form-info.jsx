...
import styles from './launch-form-info.module.css';
...
export default class LaunchFormInfo extends React.Component {
  render() {
    ...
    const name = mode === LAUNCH_MODES.tool ? toolInfo?.image : pipeline.name;
    const version = mode === LAUNCH_MODES.tool ? toolVersion?.version : pipelineVersion.name;
    const url =
      mode === LAUNCH_MODES.tool
