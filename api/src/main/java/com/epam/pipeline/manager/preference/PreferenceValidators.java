...
public final class PreferenceValidators {
    ...
    public static final BiPredicate<String, Map<String, Preference>> isValidImage = (pref, dependencies) -> {
        AmazonEC2 ec2 = AmazonEC2ClientBuilder.defaultClient();
        DescribeImagesRequest request = new DescribeImagesRequest();
        request.setFilters(Collections.singletonList(new Filter("image-id", Collections.singletonList(pref))));

        return !ec2.describeImages(request).getImages().isEmpty();
    };
