...
A later Vite/React/Vitest switch edits the harness, not test files. The file list and the
esbuild/decorators trap live in `MIGRATION.md` in this directory. Do not start that work from a
product bugfix.
