...
clair:
  database:
    ...
    options:
      ...
      source: host=$CP_CLAIR_DATABASE_HOST port=$CP_CLAIR_DATABASE_PORT user=$CP_CLAIR_DATABASE_USERNAME password=$CP_CLAIR_DATABASE_PASSWORD sslmode=${CP_CLAIR_DATABASE_SSL_MODE:-disable} statement_timeout=60000
