...
| 10 | Repeat step 4-5 | |
| 11 | Specify a existing folder name (`folder1`). Click the **OK** button | Error message `folder with that name already exists` appears |
| 12 | Click **Show History** button | Information panel opens and empty |