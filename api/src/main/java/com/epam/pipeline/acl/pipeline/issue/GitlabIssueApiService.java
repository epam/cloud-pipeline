...
public class GitlabIssueApiService {
    ...
    public GitlabIssue createIssue(final GitlabIssueVO issue) {
        return gitManager.createIssue(issue);
    }

    public GitlabIssue updateIssue(final GitlabIssueVO issue) {
    ...
    public byte[] downloadAttachment(final String secret, final String fileName) {
        return gitManager.downloadAttachment(secret, fileName);
    }
