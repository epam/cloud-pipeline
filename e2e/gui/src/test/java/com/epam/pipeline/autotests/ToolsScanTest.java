        ...
        tools()
                .perform(registry, group, fullToolName, tool ->
                        tool
                                ...
                                .validatePackageList(Arrays.asList("pip", "setuptools", "wheel"), false)
                                .filterPackages("pip")
                                .validateSearchResult("pip")
                                .validatePackageList(Collections.singletonList("pip"), false)
                                .filterPackages("pip1")
