          ...
          <Alert
            ...
            title={
              <div>
                ...
                <center>
                  Currently this is supported only for the <b>Windows</b> platform
                </center>
                <center style={{marginTop: '10px'}}>
                  Please open this page using <b>Internet Explorer</b> web browser
                </center>
              </div>
            }
          />
          ...
          <Alert
            ...
            title={
              <div>
                ...
                <center style={{marginTop: '10px'}}>
                  Please click <b>Authenticate</b> button below to obtain a <b>Single Sign-On</b>{' '}
                  token and be able to mount a cloud data storage
                </center>
              </div>
            }
          />
