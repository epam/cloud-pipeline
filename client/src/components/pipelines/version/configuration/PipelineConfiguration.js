...
@inject(({allowedInstanceTypes, pipelines, routing, preferences}, {onReloadTree, params}) => {
  return {
...
export default class PipelineConfiguration extends React.Component {
  ...
  getInstanceTypes = () => {
    ...
    const instanceTypes = [];
    for (let i = 0; i < this.props.allowedInstanceTypes.value[names.allowedInstanceTypes].length; i++) {
      const instanceType = this.props.allowedInstanceTypes.value[names.allowedInstanceTypes][i];
      ...
      <div style={{display: 'flex', flex: 1, flexDirection: 'column', height: '100%'}}>
        ...
        <Row style={{flex: 1, overflowY: 'auto', height: '100%'}}>
          <LaunchPipelineForm
            ...
            toolInstanceTypes={this.getInstanceTypes()}
