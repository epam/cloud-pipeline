...
def fetch_instance_launch_params(api, launch_adapter, run_id, inheritable_local_param_names):
    launch_params = {}
    launch_params.update(_get_inherited_worker_launch_params(api, run_id, inheritable_local_param_names))
...
def _get_inherited_worker_launch_params(api, run_id, inheritable_local_param_names):
    param_names = get_inheritable_param_names(api, inheritable_local_param_names)
    params = get_run_params(api, run_id)
    return dict(extract_params(param_names, params))


def get_inheritable_param_names(api, inheritable_local_param_names):
    return list(get_inheritable_system_param_names(api)) + inheritable_local_param_names
