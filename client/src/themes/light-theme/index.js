...
export default {
  ...
  configuration: {
    ...
    '@aws-icon-light': "@static_resource('icons/providers/aws-light.svg')",
    ...
    '@search-preview-attributes-name': 'darken(@tag-key-background-color, 5%)',
    '@search-preview-attributes-value': 'darken(@tag-value-background-color, 3%)',
    ...
    '@search-type-button-background-color': '@color-black-dimmed-25',
