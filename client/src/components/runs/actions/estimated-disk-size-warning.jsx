    ...
    if (suggestionAccepted) {
      return (
        <Alert
          ...
          title={
            <div>
              <p>The disk size is set to {displaySize(this.suggestedSize, false)}.</p>
            </div>
          }
        />
      );
          ...
          title={
            <div>
              <p>
                ...
                <span>
                  {' '}
                  (which is a hard limit). Please use the cluster run configuration to scale the
                  disks horizontally or reduce the input data volume.
                </span>
              </p>
              <p>
              ...
              <Row type="flex" justify="space-around">
                <Button type="primary" size="small" onClick={this.acceptSuggestion}>
        ...
        title={
          <div>
            <p>
              ...
              <b>{displaySize(this.requestedSize, false)}</b>
              <span>
                , but the data that is going to be processed exceeds it (estimated volume:{' '}
              </span>
