...
import static com.epam.pipeline.dto.compute.quota.FieldType.GROUPS;
import static com.epam.pipeline.dto.compute.quota.FieldType.NUMERIC;
import static com.epam.pipeline.dto.compute.quota.FieldType.STRING;
import static com.epam.pipeline.dto.compute.quota.FieldType.TAGS;
...
public enum RunField {
     ...
     * {@link QuotaFilterExpression#getDuration()}.
    ...
    RunField(final FieldType type, final boolean supportsDuration, final String... displayNames) {
        this.type = type;
