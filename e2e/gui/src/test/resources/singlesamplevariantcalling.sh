...
do
        ...
        fastqc -t $(nproc) -o $FASTQC_OUTPUT $FASTQ_R1_CURRENT $FASTQ_R2_CURRENT
        ...
        bwa mem -t $(nproc) -v 1 $REFERENCE_GENOME_FASTA_PATH $FASTQ_R1_CURRENT $FASTQ_R2_CURRENT | samtools view --threads $(nproc) -b > $BWA_OUTPUT/$SAMPLE_NAME_CURRENT.unsorted.bam
        finish_task $SAMPLE_NAME_CURRENT $?
        ...
        samtools sort -o $SORTED_OUTPUT/$SAMPLE_NAME_CURRENT.sorted.bam --threads $(nproc) $BWA_OUTPUT/$SAMPLE_NAME_CURRENT.unsorted.bam
        samtools index $SORTED_OUTPUT/$SAMPLE_NAME_CURRENT.sorted.bam
        finish_task $SAMPLE_NAME_CURRENT $?
        ...
        VarDict -th $(nproc) -G $REFERENCE_GENOME_FASTA_PATH -f 0.01 -N $SAMPLE_NAME_CURRENT -b $SORTED_OUTPUT/$SAMPLE_NAME_CURRENT.sorted.bam -c 1 -S 2 -E 3 -g 4 $PANEL | teststrandbias.R | var2vcf_valid.pl -N $SAMPLE_NAME_CURRENT -E -f 0.01 | bgzip > $VC_OUTPUT/$SAMPLE_NAME_CURRENT.vcf.gz
        tabix $VC_OUTPUT/$SAMPLE_NAME_CURRENT.vcf.gz
        finish_task $SAMPLE_NAME_CURRENT $?
