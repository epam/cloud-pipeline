...
export default class SystemNotification extends React.Component {
  ...
  renderSeverityIcon = () => {
    if (this.props.notification.type === NOTIFICATION_TYPE.message) {
      return <MailOutlined className="cp-setting-message" />;
    }
  ...
  render() {
    ...
    return (
      <div
        ...
        className={classNames(styles.notification, styles.container, 'cp-notification')}
        style={{
          right: visible ? 0 : -350,
          top: visible ? top : window.innerHeight,
          display: 'flex',
          flexDirection: 'row',
      ...
      >
        <div className={styles.iconColumn}>{this.renderSeverityIcon()}</div>
        <Row
          type="flex"
          style={{
            flex: 1,
        ...
        >
          ...
          >
            ...
            <CloseOutlined
              ...
              style={{cursor: 'pointer', padding: '5px 0 0 10px'}}
            />
          </Row>
          <Row
            style={{
          ...
          >
            <PreviewNotification text={this.props.notification.body} sanitize />
          </Row>
          <Row type="flex" justify="end">
            <span className={classNames(styles.date, 'cp-text-not-important')}>
