      ...
      <div className={className} style={style}>
        {this.configurations.map((aConfiguration) => (
          <div
            ...
            className={classNames(styles.outputRow, 'cp-even-odd-element')}
          >
        ...
        <div className={styles.addConfigurationActionsRow}>
          <Button size="small" className={styles.action} onClick={this.addOutputProperty}>
            <PlusOutlined />
            <span>Output property</span>
          </Button>
          <Button size="small" className={styles.action} onClick={this.addOutputFormula}>
            <PlusOutlined />
