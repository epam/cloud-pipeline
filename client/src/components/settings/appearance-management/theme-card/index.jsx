    ...
    >
      ...
      >
        <aside className={classNames('cp-theme-preview-navigation-panel', styles.previewAside)}>
          ...
          <div className="cp-theme-preview-navigation-menu-item selected">
            <HomeOutlined />
          </div>
          <div className="cp-theme-preview-navigation-menu-item">
            <ForkOutlined />
          ...
          <div
            ...
            className={classNames(styles.runIcon, 'cp-runs-menu-item active')}
          >
            <PlayCircleFilled />
          </div>
        </aside>
        <div style={{flex: '1 1 auto', display: 'flex', flexDirection: 'column'}}>
          <div className={styles.previewTopContainer}>
            ...
            <div className={styles.previewBtnContainer}>
              <div className={classNames('cp-theme-preview-button-primary', styles.previewBtn)}>
                &nbsp;
              </div>
              <div className={classNames('cp-theme-preview-button-danger', styles.previewBtn)}>
                &nbsp;
              </div>
          ...
          <div className={styles.previewPanelsBox}>
            <main className={classNames('cp-theme-preview-panel', styles.previewMain)}>
              <section className={classNames(styles.previewText, 'cp-theme-preview-text')}>
                &nbsp;
              </section>
              <section className={classNames(styles.previewSection, 'cp-theme-priview-panel-card')}>
                <PlayCircleOutlined
                  style={{marginLeft: '5px'}}
                  className="cp-theme-priview-runs-table-icon-blue"
                />
              </section>
              <section className={classNames(styles.previewSection, 'cp-theme-priview-panel-card')}>
                <ClockCircleOutlined
                  style={{marginLeft: '5px'}}
                  className="cp-theme-priview-runs-table-icon-yellow"
                />
              </section>
              <section className={classNames(styles.previewSection, 'cp-theme-priview-panel-card')}>
                <CheckCircleOutlined
                  style={{marginLeft: '5px'}}
                  className="cp-theme-priview-runs-table-icon-green"
                />
              </section>
            </main>
            <section className={classNames('cp-theme-preview-panel', styles.previewPanel)}>
              &nbsp;
            </section>
          </div>
        </div>
      ...
      <div className={styles.actionContainer}>
        {radio && !readOnly && (
          <Radio checked={selected} onChange={() => onSelect(identifier)}>
            <b>{name}</b>
            {tag && <span className={classNames(styles.tag, 'cp-tag', 'primary')}>{tag}</span>}
          </Radio>
        )}
        {(!radio || readOnly) && (
          <span>
