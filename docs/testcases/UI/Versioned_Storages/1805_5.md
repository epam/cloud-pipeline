...
| 6 | Confirm the upload | New file appears in the storage. <li>The commit message is set automatically (`Uploading files to folder /`) |
| 7 | Click `folder1` created in [1805_3](1805_3.md) to open it |  |
| 8 | Repeat steps 4-6 with file `CD8.jpg` | New file appears in the storage. <li>The commit message is set automatically (`Uploading files to folder folder1`) |
...
| 13 | Click ***<>*** icon near the commit for `CD8.jpg` to see difference | ***Difference for \<commit\>*** pop-up appears that contains <li>difference for `folder1/CD8.jpg` with tag `ADDED`</li><li>difference information field contains `Binary file` only |