...
export default class EditableField extends React.Component {
  ...
  onLeaveEditMode = (save) => (e) => {
    ...
    if (save && this.state.text !== this.props.text) {
      if (
        this.props.allowEpmty !== undefined &&
  ...
  renderDisplayMode = () => {
    ...
    return (
      <Tooltip mouseEnterDelay={1.5} overlay={this.props.displayText || this.props.text}>
        <div {...options}>
          <span id={this.props.displayId} className={styles.editableModeOptions}>
