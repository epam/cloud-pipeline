...
import styles from './wdl-issues.module.css';
...
function WdlIssues({
  ...
  const renderSingleIssue = (issue, idx) => {
    if (alert) {
      return (
        <Alert
          ...
          title={
            <div className={classNames(styles.wdlIssue, issueClassName)} style={issueStyle}>
              {getIssueText(issue)}
            </div>
          }
        />
    ...
    return (
      <div
        key={`issue-${idx}`}
        className={classNames(styles.wdlIssue, issueClassName, 'cp-error')}
        style={issueStyle}
      >
        {getIssueText(issue)}
      </div>
  ...
  return (
    <div className={classNames(className, styles.wdlIssuesContainer)} style={style}>
