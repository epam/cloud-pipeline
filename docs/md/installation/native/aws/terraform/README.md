...
| `instance_type`                     | (Optional) AWS EC2 Instance type to be used for Jump server deployment. Default t3.small                                             |
...
| `eks_system_node_group_instance_type`    | (Optional) AWS EC2 Instance type to be used for System node (Where all application pods will be deployed). Default m5.xlarge                                                                                                                                                          |
