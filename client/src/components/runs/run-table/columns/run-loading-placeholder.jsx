...
function RunLoadingPlaceholder({run, children, empty}) {
  if (!run) {
  ...
  if (placeholder) {
    return renderReplacement(<LoadingOutlined />);
  }
  if (error) {
...
export {RUN_LOADING_PLACEHOLDER_PROPERTY, RUN_LOADING_ERROR_PROPERTY};
