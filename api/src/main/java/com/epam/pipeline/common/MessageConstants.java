...
public final class MessageConstants {
    ...
    //Aws region
    public static final String ERROR_AWS_REGION_NOT_FOUND = "error.aws.region.not.found";
    public static final String ERROR_AWS_REGION_DEFAULT_UNDEFINED = "error.aws.region.default.undefined";
    public static final String ERROR_AWS_REGION_NAME_MISSING = "error.aws.region.name.missing";
    public static final String ERROR_AWS_REGION_REGIONID_MISSING = "error.aws.region.regionid.missing";
    public static final String ERROR_AWS_REGION_REGIONID_INVALID = "error.aws.region.regionid.invalid";
    public static final String ERROR_AWS_REGION_JSON_WRITING_FAILED = "error.aws.region.json.writing.failed";
    public static final String ERROR_AWS_REGION_CORS_RULES_INVALID = "error.aws.region.cors.rules.invalid";
    public static final String ERROR_AWS_REGION_POLICY_INVALID = "error.aws.region.policy.invalid";
