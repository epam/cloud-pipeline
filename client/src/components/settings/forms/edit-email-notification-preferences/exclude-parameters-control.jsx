...
import styles from './exclude-parameters-control.module.css';
...
function ExcludeParametersControl({parameters, pending, onChange, onAdd, onRemove}) {
  ...
  return (
    <div className={styles.container}>
      {(parameters || []).map((parameter, index) => (
        <div className={styles.controlsContainer} key={index}>
          <Input
      ...
      <Button onClick={onAddParameter} style={{width: '140px'}} disabled={pending}>
        <PlusOutlined />
        Add parameter
      </Button>
    </div>
