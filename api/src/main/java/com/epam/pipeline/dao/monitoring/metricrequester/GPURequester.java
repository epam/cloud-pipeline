...
public class GPURequester extends AbstractGPUMetricsRequester {

    private static final String ACTIVE_GPUS = "active_gpus";
        ...
        return request(from, to,
                new SearchSourceBuilder()
                        ...
                        .aggregation(ordered(AggregationBuilders.terms(AGGREGATION_NODE_NAME))
                                ...
                                .subAggregation(average(ACTIVE_GPUS, ACTIVE_GPUS))));
    }

    @Override
    public Map<String, Double> parseResponse(final SearchResponse response) {
        return collectAggregation(response, AGGREGATION_NODE_NAME, AVG_AGGREGATION + ACTIVE_GPUS);
    }
