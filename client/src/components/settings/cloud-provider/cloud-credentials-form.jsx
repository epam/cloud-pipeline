...
import styles from './cloud-credentials-form.module.css';
...
class CloudCredentialsForm extends React.Component {
  ...
  render() {
    ...
    if (this.props.cloudCredentialProfiles.pending && !this.props.cloudCredentialProfiles.loaded) {
      ...
      const {currentCredentials, createNew} = this.state;
      content = (
        <div>
          {!this.readOnly && (
            <div className={styles.header}>
              <span style={{fontWeight: 'bold'}}>Cloud Credentials Profiles</span>
              <Button size="small" onClick={this.onCreateNewClicked}>
                <PlusOutlined />
