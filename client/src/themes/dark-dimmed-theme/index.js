...
export default {
  ...
  configuration: {
    ...
    '@search-header-light-color': '@application-color',
    '@search-preview-text-color': '@application-color',
    '@search-preview-attributes-name': 'lighten(@tag-key-background-color, 5%)',
    '@search-preview-attributes-value': '@tag-value-background-color',
    '@search-preview-attributes-value-hovered': 'darken(@tag-key-background-color, 5%)',
    ...
    '@search-type-button-background-color': 'fadeout(@application-background-color, 50%)',
    '@search-type-button-selected': 'lighten(@search-type-button-background-color, 10%)',
    '@search-type-button-hover': 'lighten(@search-type-button-background-color, 7%)',
    '@search-type-button-disabled': 'lighten(@application-background-color, 7%)',
