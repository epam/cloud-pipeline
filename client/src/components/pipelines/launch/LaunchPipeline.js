...
@inject(({allowedInstanceTypes, awsRegions, routing, pipelines, preferences}, {params}) => {
  ...
  return {
    allowedInstanceTypes: params.image ? allowedInstanceTypes.getAllowedTypes(params.image) : allowedInstanceTypes,
    awsRegions,
    preferences,
...
export default class LaunchPipeline extends localization.LocalizedReactComponent {
  ...
  getParameters = () => {
    if (this.props.tool && !this.toolPending && !this.toolSettingsPending && !this.props.tool.error) {
      ...
      if (this.props.run.value.instance) {
        ...
        parameters.awsRegionId = this.getAwsRegionId(this.props.run.value.instance.awsRegionId);
      }
  ...
  render () {
    ...
    if (this.props.allowedInstanceTypes && this.props.allowedInstanceTypes.error) {
      errors.push(this.props.allowedInstanceTypes.error);
    }
    ...
    return (
      <Card
        ...
        <LaunchPipelineForm
          ...
          instanceTypes={
            this.getInstanceTypes(this.props.allowedInstanceTypes.value[names.allowedInstanceTypes])
          }
          toolInstanceTypes={
            this.getInstanceTypes(this.props.allowedInstanceTypes.value[names.allowedToolInstanceTypes])
          }
