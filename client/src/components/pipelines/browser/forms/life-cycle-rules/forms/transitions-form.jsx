...
import {Form, DatePicker, Radio, Select, Input, Button, Alert} from 'antd';
...
class TransitionsForm extends React.Component {
  ...
  get formDestinations() {
    ...
    return transitions.map((_, index) =>
      form.getFieldValue(['transitions', index, 'storageClass']),
    );
  }
  ...
  setFormInitialValues = () => {
    ...
    this.setState(
      {
        transitions: rule.transitions && rule.transitions.length ? rule.transitions : [blankRule],
      },
