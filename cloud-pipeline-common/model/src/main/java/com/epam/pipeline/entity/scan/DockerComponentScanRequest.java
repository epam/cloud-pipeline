...
@Setter
@NoArgsConstructor
public class DockerComponentScanRequest {
    private Layer layer;

    public DockerComponentScanRequest(String name, String digest, String registryPath, String image,
                                      String parentDigest, String userName, String password) {
    ...
    public DockerComponentScanRequest(String name, String digest, String registryPath, String image,
                                      String parentDigest, String token) {
        this.layer = new Layer();
        this.layer.name = name;
        this.layer.path = String.format("https://%s/v2/%s/blobs/%s", registryPath, image, digest);
