...
public class InstanceOfferDao extends NamedParameterJdbcDaoSupport {
    ...
    private String createInstanceOfferQuery;
    private String removeInstanceOffersQuery;
    private String loadInstanceOfferQuery;
    private String loadFirstInstanceOffer;
    private String loadInstanceTypesQuery;
    private String removeInstanceOffersForRegionQuery;
    ...
    @Transactional(propagation = Propagation.MANDATORY)
    public void removeInstanceOffersForRegion(String awsRegion) {
        getJdbcTemplate().update(removeInstanceOffersForRegionQuery, awsRegion);
    }
    ...
    private String makeFilterCondition(InstanceOfferRequestVO requestVO, MapSqlParameterSource params) {
        ...
        if (!requestVO.isEmpty()) {
            ...
            if (requestVO.getRegion() != null) {
                if (clausesCount > 0) {
                    whereBuilder.append(AND);
                }
                whereBuilder.append(" i.region = :").append(InstanceOfferParameters.REGION.name());
                params.addValue(InstanceOfferParameters.REGION.name(), requestVO.getRegion());
            }
        }
    ...
    enum InstanceOfferParameters {
        ...
        static MapSqlParameterSource getParameters(InstanceOffer instanceOffer) {
            ...
            params.addValue(REGION.name(), instanceOffer.getRegion());
            return params;
        }
        ...
        static RowMapper<InstanceOffer> getRowMapper() {
            return (rs, rowNum) -> {
                ...
                instanceOffer.setRegion(rs.getString(REGION.name()));
    ...
    @Required
    public void setCreateInstanceOfferQuery(String query) {
        this.createInstanceOfferQuery = query;
    }

    @Required
    public void setRemoveInstanceOffersQuery(String query) {
        this.removeInstanceOffersQuery = query;
    }

    @Required
    public void setLoadInstanceOfferQuery(String query) {
        this.loadInstanceOfferQuery = query;
    }

    @Required
    public void setLoadFirstInstanceOffer(String query) {
        this.loadFirstInstanceOffer = query;
    }

    @Required
    public void setLoadInstanceTypesQuery(String query) {
        this.loadInstanceTypesQuery = query;
    }

    @Required
    public void setRemoveInstanceOffersForRegionQuery(String removeInstanceOffersForRegionQuery) {
        this.removeInstanceOffersForRegionQuery = removeInstanceOffersForRegionQuery;
    }
}
