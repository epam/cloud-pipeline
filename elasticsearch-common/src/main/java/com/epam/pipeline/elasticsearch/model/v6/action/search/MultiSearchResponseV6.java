...
public class MultiSearchResponseV6 implements MultiSearchResponseInner {

    @RequiredArgsConstructor
    public static class Item implements MultiSearchResponseInner.Item {

        private final org.elasticsearch.action.search.MultiSearchResponse.Item inner;

        @Override
        public SearchResponse getResponse() {
            return new SearchResponseV6(inner.getResponse());
        }
    }

    private final org.elasticsearch.action.search.MultiSearchResponse inner;
