...
export default class CreateConfigurationForm extends React.Component {
  ...
  render() {
    ...
    const description =
      this.props.pipeline && this.props.pipeline.description ? this.props.pipeline.description : '';
    return (
      <Modal
        ...
        <Spin spinning={this.props.pending}>
          ...
          >
            ...
            <Form.Item
              ...
              name="description"
            >
              <Input.TextArea autoSize={{minRows: 2, maxRows: 6}} disabled={this.props.pending} />
            </Form.Item>
            <Form.Item
