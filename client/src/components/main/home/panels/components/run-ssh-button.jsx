...
class RunSSHButton extends React.Component {
  ...
  loadRunSSHConfiguration = () => {
    ...
    const {pending, sshConfiguration, error} = this.state;
  ...
  render() {
    const {pending, error, sshConfiguration} = this.state;
    const {visibilityChanged, style, className, icon = null} = this.props;
