...
public class InstanceOfferManagerUnitTest {
    ...
    private final InstanceType m4InstanceType = instanceType(M4_LARGE);
    private final InstanceType m5InstanceType = instanceType(M5_LARGE);
    private final InstanceType t2InstanceType = instanceType(T2_LARGE);
    ...
    private final EC2Helper ec2Helper = mock(EC2Helper.class);
    private final PreferenceManager preferenceManager = mock(PreferenceManager.class);
    private final AwsRegionManager awsRegionManager = mock(AwsRegionManager.class);
    ...
    private final InstanceOfferManager instanceOfferManager = new InstanceOfferManager(instanceOfferDao, versionManager,
            pipelineRunManager, messageHelper, ec2Helper, preferenceManager, awsRegionManager,
            contextualPreferenceManager);
    ...
    public void getAllowedInstanceAndPriceTypesShouldSearchPreferencesIfToolIdIsNull() {
        ...
        final AllowedInstanceAndPriceTypes allowedInstanceAndPriceTypes =
                instanceOfferManager.getAllowedInstanceAndPriceTypes(null);
    ...
    public void getAllowedInstanceAndPriceTypesShouldSearchPreferencesUsingToolAsExternalResourceIfToolIdIsSpecified() {
        ...
        final AllowedInstanceAndPriceTypes allowedInstanceAndPriceTypes =
                instanceOfferManager.getAllowedInstanceAndPriceTypes(TOOL_ID);
