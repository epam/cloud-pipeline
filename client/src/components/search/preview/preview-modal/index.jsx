...
class PreviewModal extends React.Component {
  ...
  onPreviewLoaded = (options = {}) => {
    const {maximizedAvailable = false, requireMaximumSpace = false} = options;
    this.setState({
      maximizedAvailable,
      requireMaximumSpace,
    });
  ...
  render() {
    const {preview, onClose, closable} = this.props;
    if (!preview) {
      return null;
    }
    const {maximized, maximizedAvailable, requireMaximumSpace} = this.state;
    ...
    return (
      ...
      >
        ...
        >
          ...
          <CloseOutlined
            className={classNames(styles.previewButton, styles.close, 'cp-search-preview-button')}
