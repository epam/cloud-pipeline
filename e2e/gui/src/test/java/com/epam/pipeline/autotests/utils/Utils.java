...
public class Utils {
    ...
    public static void assertStringContainsList(String str, String...subStrings) {
         Arrays.stream(subStrings).forEach(substr -> assertTrue(str.contains(substr), format("'%s' doesn't exist in string", substr)));
        }
}
