...
public class CacheConfiguration {
    ...
    public RedisCacheManager redisCacheManagerPref(final RedisConnectionFactory connectionFactory) {
        RedisCacheConfiguration cacheConfiguration = RedisCacheConfiguration
            .defaultCacheConfig()
            // Here you configure the key/value serialization.
            // For 'Preference', if it's a JSON object you'll want Jackson2JsonRedisSerializer.
            // Assuming the Preference objects are serializable into JSON:
        ...
        // 2. Create a RedisCacheWriter from the connection factory
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory);

        // 3. Build the cache manager
