...
import styles from './EditSystemNotificationForm.module.css';
...
export default class EditSystemNotificationForm extends React.Component {
  ...
  render() {
    const isNewNotification =
      this.props.notification === undefined || this.props.notification === null;
    const notification = this.props.notification;
    ...
    return (
      <Modal
        ...
        title={isNewNotification ? 'Create notification' : 'Edit notification'}
