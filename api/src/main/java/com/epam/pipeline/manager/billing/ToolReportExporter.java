...
public class ToolReportExporter implements BillingExporter {
    ...
    @Getter
    private final BillingExportType type = BillingExportType.TOOL_REPORT;
    ...
    public void export(final BillingExportRequest request, final OutputStream out) {
        try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(out);
             ...
             ToolReportWriter writer = new ToolReportWriter(bufferedWriter, billingHelper,
    ...
    private Stream<ToolReportBilling> billings(final BillingExportRequest request,
