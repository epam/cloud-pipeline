...
export default function ({onChange, value}) {
  ...
  return (
    <Radio.Group value={correctedValue} onChange={onRadioGroupValueChange} size="small">
      <Radio.Button key={InstanceMetrics.costs} value={InstanceMetrics.costs}>
        Cost
      </Radio.Button>
      <Radio.Button key={InstanceMetrics.usage} value={InstanceMetrics.usage}>
        Usage (hours)
      </Radio.Button>
      <Radio.Button key={InstanceMetrics.runs} value={InstanceMetrics.runs}>
        Runs
      </Radio.Button>
    </Radio.Group>
  );
...
export {filters as InstanceFilters, getSummaryDatasets};
