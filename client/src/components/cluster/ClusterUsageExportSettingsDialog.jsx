...
import styles from './ClusterUsageExportSettingsDialog.module.css';
...
class ClusterUsageExportSettingsDialog extends React.Component {
  ...
  render() {
    const {availableIntervals, disabled, onCancel, visible} = this.props;
    const {mode, tick} = this.state;
    return (
      <Modal
        ...
        footer={
          <div className={styles.footer}>
            ...
            <Button disabled={disabled} type="primary" onClick={this.onExportClicked}>
              EXPORT
            </Button>
          </div>
        }
      >
        <div className={styles.formItem}>
          ...
          <Select disabled={disabled} style={{flex: 1}} value={mode} onChange={this.onModeChanged}>
        ...
        <div className={styles.formItem}>
          <span className={styles.label}>Ticks:</span>
          <Select
            disabled={disabled}
            allowClear
            style={{flex: 1}}
