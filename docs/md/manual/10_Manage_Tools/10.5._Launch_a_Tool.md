...
1. Open the Tools page and find RStudio tool:  
    ![CP_LaunchTool](attachments/LaunchTool_36.png)
2. At the tool's page, click the **Settings** tab:  
    ![CP_LaunchTool](attachments/LaunchTool_37.png)  
    Save endpoints' port values.
3. Select **Run** → **Custom settings**:  
    ![CP_LaunchTool](attachments/LaunchTool_38.png)
4. At the **Launch** page, expand the **Advanced** section and click the **Configure** button near the "_Internal DNS name_" label:  
    ![CP_LaunchTool](attachments/LaunchTool_39.png)
5. In the appeared pop-up, specify the service name, e.g.:  
    ![CP_LaunchTool](attachments/LaunchTool_40.png)
6. Specify ports saved at step 2. To add the second port use "**+ Add ports configuration**" button:  
    ![CP_LaunchTool](attachments/LaunchTool_41.png)  
    Click the Save button.
7. Check that configured service is displayed at the **Launch** page:  
    ![CP_LaunchTool](attachments/LaunchTool_42.png)
8. Click the **Launch** button and launch the run.
9. Open the **Run logs** page of the just-launched run.
10. [**FQDN**](https://en.wikipedia.org/wiki/Fully_qualified_domain_name) of both configured services are shown in the GUI - at the **Run logs** page:  
    ![CP_LaunchTool](attachments/LaunchTool_43.png)  
...
13. In the opened terminal, perform the command: `curl -I rstudio-example-service.default.svc.cluster.local:8788` to view info about **_RStudio_** hosted service:  
    ![CP_LaunchTool](attachments/LaunchTool_44.png)
14. Perform the command: `curl -I rstudio-example-service.default.svc.cluster.local:3838` to view info about **_Shiny_** hosted service:  
    ![CP_LaunchTool](attachments/LaunchTool_45.png)
