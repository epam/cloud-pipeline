...
function ApplicationVersion({className, style, preferences, applicationInfo}) {
  const deploymentName =
    (preferences.loaded ? preferences.deploymentName : undefined) || 'EPAM Cloud Pipeline';
  let versionDescription = VERSION;
  if (applicationInfo.loaded) {
    const {version = VERSION, prettyName} = applicationInfo.value || {};
