...
function ThemeCard (props) {
  const {name, identifier, selected} = props;
  return (
    <div className={classNames(
      ...
      <div className={styles.aspectRatioInner}>
        <article className={classNames('cp-theme-preview-layout', styles.previewArticle)} >
          ...
          <div style={{flex: '1 1 auto', display: 'flex', flexDirection: 'column'}}>
            <div className={styles.previewTopContainer}>
              <div className={classNames(styles.previewTextShort, 'cp-theme-preview-text')}>&nbsp;</div>
