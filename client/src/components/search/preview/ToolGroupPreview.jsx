  ...
  renderImageName = (tool) => {
        ...
        <Row style={{flex: 1}}>
          ...
          >
            {tool.shortDescription && (
              <Row
                style={tool.labels ? {marginBottom: 5, wordWrap: 'normal'} : {wordWrap: 'normal'}}
              >
                {tool.shortDescription}
              </Row>
            )}
    ...
    return (
      <Row type="flex">
        {tool.iconId && (
          <div
            style={{marginRight: 5, overflow: 'hidden', width: 33, height: 33, alignSelf: 'center'}}
          >
          ...
          <tbody>
            {this.tools.map((item, index) => {
              return (
                ...
                >
                  <td className={styles.firstCell}>{this.renderImageName(item)}</td>
                </tr>
              );
            })}
          </tbody>
