...
@Service
public class PublishActionNotificationService implements ActionNotificationService {

    @Override
    public void process(String oldVersion, String newVersion, List<JiraIssue> jiraIssues,
