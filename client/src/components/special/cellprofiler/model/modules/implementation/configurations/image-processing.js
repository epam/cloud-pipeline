...
const correctIlluminationApply = {
  ...
  parameters: [
    ...
    'Select how the illumination function is applied|[Divide,Substract]|Divide',
...
const enhanceOrSuppressFeatures = {
  ...
  parameters: [
    ...
    'Smoothing scale|float|2.0|IF method==Tubeness',
    'Feature size|integer|10|IF (operation==Suppress OR method=Line structures OR feature==Circles OR feature==Speckles)',
...
const overlayObjects = {
  ...
  parameters: [
    'Input|file',
    'Name the output image|string|OverlayObjects|ALIAS name',
    'Objects|object',
    'Opacity|float|0.3'
  ]
};
...
const overlayOutlines = {
  ...
  parameters: [
    ...
    'Select method to determine brightness of outlines|[Max of image,Max possible]|Max of image|IF mode==Grayscale',
    {
      name: 'output',
      ...
      valueFormatter: (value, cpModule) => {
        const grayScale = cpModule &&
          cpModule.getParameterValue('displayMode') === 'Grayscale';
...
const threshold = {
  ...
  parameters: [
    ...
    'Assign pixels in the middle intensity class to the foreground or the background?|[Background,Foreground]|Background|IF (thresholdingMethod==Otsu AND otsuMethodType=="Three classes")',
    ...
    'Size of adaptive window|integer|50|IF strategy==Adaptive',
