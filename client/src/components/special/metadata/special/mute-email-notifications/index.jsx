...
function MuteEmailNotifications({
  ...
  const {muted} = parseMuteEmailNotificationValue(value);
  const handleChange = (event) => {
    const displayAfter = dayjs.utc();
  ...
  return (
    <div style={Object.assign({margin: '5px 0'}, style || {})}>
      <Checkbox onChange={handleChange} checked={muted} disabled={disabled || readOnly}>
