...
class ObjectsOutline extends React.Component {
  ...
  updateOutlines = () => {
    const {pipeline, viewer} = this.props;
    ...
    this.setState(
      ...
      () => {
        pipeline.graphicsOutput.renderOutlines(viewer).then(() => {
          this.setState({
            pending: false,
          });
        });
  ...
  render() {
    const {className, style, pipeline, viewer} = this.props;
    if (
      !pipeline ||
    ...
    return (
      <div className={classNames(className, styles.cpAnalysisObjectsOutlines)} style={style}>
        <div className={styles.cpAnalysisObjectsOutlineRow}>
          <b>Objects</b>
          <Checkbox
            disabled={pending}
        ...
        {configurations.map((config, index) => (
          <div key={config.object} className={styles.cpAnalysisObjectsOutlineRow}>
            <Checkbox
