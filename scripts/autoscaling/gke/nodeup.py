#!/opt/local/mamba/envs/gke/bin/python
...
from pipeline.api.api import TaskStatus
import gkeprovider
import pipeline.autoscaling.kubeprovider as kubeprovider
...
def main():
    ...
    cloud_provider = gkeprovider.GKEInstanceProvider(region_id)
