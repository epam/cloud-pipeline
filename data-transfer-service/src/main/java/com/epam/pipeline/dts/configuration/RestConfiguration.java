...
public class RestConfiguration implements WebMvcConfigurer {
    ...
    public void configurePathMatch(PathMatchConfigurer configurer) {
        ...
        configurer.addPathPrefix("/restapi", HandlerTypePredicate.forBasePackage(
                "com.epam.pipeline.dts.transfer.rest.controller",
                "com.epam.pipeline.dts.listing.rest.controller",
                "com.epam.pipeline.dts.submission.rest.controller"));
    }
