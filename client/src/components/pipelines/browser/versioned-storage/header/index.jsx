...
class VersionedStorageHeader extends localization.LocalizedReactComponent {
  ...
  render() {
    const {pipeline, pipelineId, readOnly} = this.props;
    ...
    return (
      <div className={styles.headerContainer}>
        ...
        <Row type="flex">{pipeline.value.description}</Row>
      </div>
    );
  }
}
