...
import com.epam.pipeline.app.StorageConfiguration;
...
@ContextConfiguration(classes = {AspectTestBeans.class, CommonTestContext.class, StorageConfiguration.class})
