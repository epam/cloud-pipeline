...
@inject('uiNavigation', 'impersonation', 'preferences', 'counter', 'userNotifications')
@observer
class Navigation extends React.Component {
  ...
  get navigationItems() {
    ...
    return uiNavigation.navigationItems.filter((item) => !item.hidden);
  }
  ...
  menuItemClassSelector = (navigationItem, activeItem) => {
    return classNames('cp-navigation-menu-item', {
      selected: navigationItem.key === activeItem,
    });
  };

  highlightedMenuItemClassSelector = (navigationItem, activeItem) => {
    return classNames('cp-navigation-menu-item', 'cp-runs-menu-item', {
      selected: navigationItem.key === activeItem,
    });
  };
  ...
  render() {
    ...
    const menuItems = this.navigationItems
      ...
      .map((navigationItem, index) => {
        if (navigationItem.isDivider) {
          return (
            <div
              className={classNames('cp-divider', 'horizontal', 'cp-navigation-divider')}
              key={`divider_${index}`}
            />
          );
        }
    ...
    return (
      <div
        ...
        className={classNames('cp-navigation-panel', {
      ...
      >
        <div
          className={classNames(searchStyles.searchBlur, {
        ...
        >
          ...
          >
            <Button id="navigation-button-logo" type="text" className="cp-navigation-menu-item">
