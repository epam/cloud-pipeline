...
import com.epam.pipeline.external.datastorage.security.OptionalSAMLLogoutFilter;
import com.epam.pipeline.external.datastorage.security.SAMLContextProviderCustomSingKey;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
            ...
            .antMatchers(SECURED_RESOURCES_ROOT).authenticated()
    ...
    protected RequestMatcher getFullRequestMatcher() {
        List<RequestMatcher> matchers =
            Arrays.stream(SECURED_RESOURCES_ROOT).map(AntPathRequestMatcher::new)
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        String url = endpointId.endsWith("/") ? endpointId.substring(0, endpointId.length() - 1) : endpointId;
    ...
    public FilterChainProxy samlFilter() throws Exception {
        ...
        chains.add(new DefaultSecurityFilterChain(new AntPathRequestMatcher("/saml/SSO/**"), // /SSO or /auth
    ...
    public SAMLContextProviderImpl contextProvider() {
        return new SAMLContextProviderCustomSingKey(signingKey);
    }
