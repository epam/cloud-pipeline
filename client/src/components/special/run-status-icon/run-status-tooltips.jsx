...
export default {
  [Statuses.failure]: {
    description:
      'Run execution failure may occur for a lot of reasons: ' +
  ...
  [Statuses.paused]: {
    description:
      'Run is paused. At this moment compute node is already ' +
  ...
  [Statuses.pausing]: {
    description:
      'Run is being paused. At this moment compute node will be stopped ' +
  ...
  [Statuses.pulling]: {
    description:
      'Compute node is available and a job is assigned. ' +
  ...
  [Statuses.queued]: {
    description:
      'Job is waiting in the queue for the available compute node. ' +
  ...
  [Statuses.running]: {
    description:
      'Compute environment is pulled to the compute node. ' +
  ...
  [Statuses.scheduled]: {
    description:
      'Run is being initialized, at this stage a new compute node ' +
