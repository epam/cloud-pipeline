...
public enum BillingDetailsOrderAggregate {
    ...
    STANDARD(BillingGrouping.STORAGE,  getSortOrder("standard_total_cost"),getSortOrder("standard_total_usage_bytes")),
    GLACIER(BillingGrouping.STORAGE,getSortOrder("glacier_total_cost"), getSortOrder("glacier_total_usage_bytes")),
    GLACIER_IR(BillingGrouping.STORAGE,getSortOrder("glacier_ir_total_cost"), getSortOrder("glacier_ir_total_usage_bytes")),
    DEEP_ARCHIVE(BillingGrouping.STORAGE,getSortOrder("deep_archive_total_cost"), getSortOrder("deep_archive_total_usage_bytes"));
