...
class Schedule extends React.Component {
  ...
  saveRunSchedule = (rules) => {
    ...
    const wrapRequest = (Request, payload) =>
  ...
  render() {
    ...
    const pending =
      operationInProgress || !this.schedule || (this.schedule.pending && !this.schedule.loaded);
    return (
      <div style={{display: 'inline'}}>
        <Button disabled={pending} size="small" onClick={this.openScheduleModal}>
