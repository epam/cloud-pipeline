...
class PipelineLatestVersion extends React.PureComponent {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    const {pipeline: propPipeline} = routeParams;
  ...
  navigate = () => {
    const {location = {}, routeParams = {}, pipelines, router} = this.props || {};
    const {pipeline, section, subSection} = routeParams;
