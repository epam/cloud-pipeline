...
| 3 | Open the storage  from the [_2182\_2_](2182_2.md) Prerequisites | |
...
| 7 | Open the storage  from the [_2182\_2_](2182_2.md) Prerequisites | Storage page opens and contains: <li> Storage size is 1.5 Gb <li> ***Warning*** icon is displayed. <li> *Storage status is: MOUNT IS DISABLED* is shown on the ***Warning*** icon tooltip <li> **Create** and **Upload** buttons are shown |
...
| 15 | Open the storage  from the [_2182\_2_](2182_2.md) Prerequisites | Storage page opens and contains: <li> Storage size is 0 <li> ***Warning*** icon disappears. <li> **Create** and **Upload** buttons are shown |
