...
public class PipelineRunManagerTest extends AbstractManagerTest {
    ...
    public void setUp() throws Exception {
        ...
        when(instanceOfferManager.getInstanceEstimatedPrice(anyString(), anyInt(), anyBoolean(), anyString()))
                .thenReturn(price);
    ...
    public void testRunCmdFailed() {
        ...
        preferenceManager.update(Arrays.asList(new Preference(
    ...
    public void testLaunchPipelineValidatesToolInstanceType() {
        pipelineRunManager.launchPipeline(configuration, null, null, INSTANCE_TYPE, null, null, null, null,
                null, null, null);

        verify(instanceOfferManager).isToolInstanceAllowed(eq(INSTANCE_TYPE), any());
    }
    ...
    public void testLaunchPipelineFailsOnNotAllowedToolInstanceType() {
        when(instanceOfferManager.isToolInstanceAllowed(eq(INSTANCE_TYPE), any())).thenReturn(false);

        assertThrows(e -> e.getMessage().contains("not allowed"),
            () -> pipelineRunManager.launchPipeline(configuration, null, null, INSTANCE_TYPE, null, null,
    ...
    public void testLaunchPipelineDoesNotValidateToolInstanceTypeIfItIsNotSpecified() {
        pipelineRunManager.launchPipeline(configuration, null, null, null, null, null, null, null, null, null, null);

        verify(instanceOfferManager, times(0)).isInstanceAllowed(any());
    ...
    public void testLaunchPipelineValidatesPipelineInstanceType() {
        pipelineRunManager.launchPipeline(configuration, new Pipeline(), null, INSTANCE_TYPE, null, null, null, null,
                null, null, null);
    ...
    public void testLaunchPipelineFailsOnNotAllowedInstanceType() {
        when(instanceOfferManager.isInstanceAllowed(eq(INSTANCE_TYPE))).thenReturn(false);

        assertThrows(e -> e.getMessage().contains("not allowed"),
            () -> pipelineRunManager.launchPipeline(configuration, new Pipeline(), null, INSTANCE_TYPE, null,
    ...
    public void testLaunchPipelineDoesNotValidatePipelineInstanceTypeIfItIsNotSpecified() {
        pipelineRunManager.launchPipeline(configuration, new Pipeline(), null, null, null, null, null, null, null, null,
                null);
