...
import HCSImageViewer from './viewer';

/**
 * @typedef {Object} WrapperCallbacks
 ...
 * @param {Object} props
 * @param {WrapperCallbacks} callbacks
 */
export default function wrapper(container, props, callbacks = {}) {
  const {
    onStateChange,
