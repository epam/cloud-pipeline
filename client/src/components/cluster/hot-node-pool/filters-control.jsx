...
import FilterControl, {criteriaValid, criteriaEqual, mapCriteria} from './filter-control';
import styles from './filters-control.module.css';
  ...
  render() {
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={classNames(styles.row, styles.multiRow)}>
          ...
          <div className={styles.column}>
            ...
            <div>
              <Button disabled={disabled} type="dashed" onClick={this.onAddFilter}>
                <PlusOutlined />
                Add filter
              </Button>
            </div>
