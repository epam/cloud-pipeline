...
public class PipelineRunParameterJsonConverter extends AbstractFilterValueConverter {
    ...
    public Object convert(String field,
        ...
        return String.format("{\"%s\" : {\"name\": \"%s\", \"value\": \"%s\"}}",
                this.getParameterName(field), this.getParameterName(field), this.clearQuotes(value));
    }
}
