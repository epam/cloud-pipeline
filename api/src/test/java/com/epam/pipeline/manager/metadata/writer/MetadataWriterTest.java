...
public class MetadataWriterTest {
    ...
    private void assertCsvEquals(final String expectedCsv, final String actualCsv) {
        ...
        assertTrue(expectedLines.size() == actualLines.size() && expectedLines.containsAll(actualLines)
            && actualLines.containsAll(expectedLines), String.format("Csv content mismatch:\nExpected:%s\nActual:%s",
