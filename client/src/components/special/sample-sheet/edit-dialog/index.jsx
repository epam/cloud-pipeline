...
import {Button, Modal, message, Switch, Upload} from 'antd';
import {UploadOutlined} from '@ant-design/icons';
import SampleSheet from '../edit-form';
import CodeEditor from '../../CodeEditor';
import {isSampleSheetContent} from '../utilities';
import styles from './sample-sheet-edit-dialog.module.css';
...
class SampleSheetEditDialog extends React.Component {
  ...
  render() {
    const {visible, onClose, title, removable, onRemove} = this.props;
    const {content, textMode} = this.state;
    return (
      <Modal
        open={visible}
        onCancel={onClose}
          ...
          <div className={styles.title}>
            ...
            <div>
              ...
              <div style={{display: 'inline-flex', marginLeft: 5}}>
                <Upload fileList={[]} key="upload" beforeUpload={this.onUpload} multiple={false}>
                  <Button>
        ...
        footer={
          <div className={styles.footer}>
            ...
            <div>
              ...
              <Button type="primary" onClick={this.onSaveClicked}>
                SAVE
              </Button>
            </div>
          </div>
      ...
      >
        ...
        {!textMode && visible && (
          <SampleSheet editable content={content} onChange={this.onChange} />
        )}
      </Modal>
    );
  }
