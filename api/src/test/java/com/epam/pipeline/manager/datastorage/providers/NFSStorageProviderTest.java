...
public class NFSStorageProviderTest extends AbstractSpringTest {
    ...
    public void getNfsRootPathTest() {
        String nfsRootPath = nfsProvider.getNfsRootPath(TEST_PATH + ":" + "directory");
        Assert.assertEquals(TEST_PATH + ":", nfsRootPath);
        nfsRootPath = nfsProvider.getNfsRootPath(TEST_PATH + ":" + "/directory");
        Assert.assertEquals(TEST_PATH + ":/", nfsRootPath);
        nfsRootPath = nfsProvider.getNfsRootPath(TEST_PATH + ":" + "/mnt/directory");
        Assert.assertEquals(TEST_PATH + ":/", nfsRootPath);
        nfsRootPath = nfsProvider.getNfsRootPath(TEST_PATH + ":" + "mnt/directory");
        Assert.assertEquals(TEST_PATH + ":", nfsRootPath);
    }
    ...
    public void getNfsRootPathShouldFailIfPathInvalid() {
        nfsProvider.getNfsRootPath(TEST_PATH + ":");
    }
}