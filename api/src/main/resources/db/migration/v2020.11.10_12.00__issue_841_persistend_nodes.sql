...
CREATE SEQUENCE IF NOT EXISTS pipeline.s_persistent_node START WITH 1 INCREMENT BY 1;

CREATE TABLE IF NOT EXISTS pipeline.persistent_node (
  id BIGINT PRIMARY KEY DEFAULT nextval('pipeline.s_persistent_node'),
  created_date TIMESTAMP WITH TIME ZONE NOT NULL,
  name TEXT,
