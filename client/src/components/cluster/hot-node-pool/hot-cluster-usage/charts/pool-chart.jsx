...
import styles from './cluster-chart.module.css';
import {getFadedColor} from './utils/colors';

const extractDataSets = (rawData, currentPoolId, colorOptions) => {
...
function PoolChart({
  ...
  const dataConfiguration = extractDataSets(rawData, currentPoolId, colorOptions);
  const options = {
  ...
  return (
    <div className={classNames(className, styles.container)} style={containerStyle}>
      <div
        style={Object.assign(
          {
            width: '100%',
