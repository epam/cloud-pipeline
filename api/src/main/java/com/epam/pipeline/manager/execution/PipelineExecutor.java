...
public class PipelineExecutor {
    ...
    private static final String NETWORK_POLICY_ISOLATE = "isolate";
    ...
    private String getNetworkPolicyType(final PipelineRun run, final List<EnvVar> envVars) {
        if (isParameterEqual(envVars, CP_CAP_NETWORK_POLICY_TYPE, NETWORK_POLICY_SENSITIVE)
                || Boolean.TRUE.equals(run.getSensitive())) {
            return NETWORK_POLICY_SENSITIVE;
        } else if (isParameterEqual(envVars, CP_CAP_NETWORK_POLICY_TYPE, NETWORK_POLICY_ISOLATE)) {
            return NETWORK_POLICY_ISOLATE;
        } else {
