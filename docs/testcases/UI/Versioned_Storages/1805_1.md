...
| 5 | Input name contains invalid characters into the ***Name*** field. Click **Create** button | Error message `Repository name can contain only letters, digits, "_", "-", and "."`  automatically appears under the ***Name*** field |
...
| 10 | Click **Show History** button | Information panel opens and empty |
| 11 | Repeat steps 2-4 | |
| 12 | Input `VS1` name into the ***Name*** field. Click **Create** button | Error message `'VS1' already exists in repository.` appears |