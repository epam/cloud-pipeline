...
import { REMOTE_CP_AUTHORITY } from "./authResolver";
...
export class RemoteLocationHistory {
  ...
  constructor(private context: vscode.ExtensionContext) {
    ...
    this.remoteLocationHistory =
      context.globalState.get(RemoteLocationHistory.STORAGE_KEY) || {};
  }
...
export function getRemoteWorkspaceLocationData(): [string, string] | undefined {
  ...
  if (
    ...
    location.authority.startsWith(REMOTE_CP_AUTHORITY) &&
