...
public class PipeRunCmdBuilderTest {
    ...
    public void shouldGenerateLaunchCommand() {
        ...
        final String expectedResult = String.format(buildExpectedForLinux("pipe run", "-n 1@%s", "-p", "-y",
                ...
                TEST_PARAM_NAME_3, String.format(PARAM_WTH_TYPE_TEMPLATE, PARAM_INPUT_TYPE, TEST_PARAM_VALUE_MULTIPLE_PATHS),
                TEST_PARAM_NAME_4, String.format(PARAM_WTH_TYPE_TEMPLATE, PARAM_OUTPUT_TYPE, TEST_PARAM_VALUE_MULTIPLE_PATHS),
                TEST_PARAM_NAME_5, String.format(PARAM_WTH_TYPE_TEMPLATE, PARAM_PATH_TYPE, TEST_PARAM_VALUE_MULTIPLE_PATHS),
                TEST_PARAM_NAME_6, String.format(PARAM_WTH_TYPE_TEMPLATE, PARAM_COMMON_TYPE, TEST_PARAM_VALUE_MULTIPLE_PATHS),
