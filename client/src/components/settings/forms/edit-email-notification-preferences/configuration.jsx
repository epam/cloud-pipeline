...
const IdleNotificationsTitle = (
  <div>
    {}
    Common <b>Idle</b>-notifications ( <i>IDLE_RUN</i>, <i>IDLE_RUN_PAUSED</i>,{' '}
    <i>IDLE_RUN_STOPPED</i> ) settings
  </div>
);
...
const SystemDiskConsumeThresholdPreference = {
  ...
  hint: (
    <div>
      <b>Specifies disk threshold (in %)</b> above which the notification will be sent
      <br />
...
const SystemMemoryConsumeThresholdPreference = {
  ...
  hint: (
    <div>
      <b>Specifies memory threshold (in %)</b> above which the notification will be sent
      <br />
      and the corresponding run will be marked by the
      <span
        className="cp-tag critical"
...
const SystemMaxIdleTimeoutMinutesPreference = {
  ...
  hint: (
    <div>
      <b>Specifies a duration in minutes.</b>
      <br />
      This is a period during which the <i>idle</i> state of the run is not being checked.
      <br />
      After this period, the System starts to verify CPU utilization of the running node
      <br />
...
const SystemIdleActionTimeoutMinutesPreference = {
  ...
  hint: (
    <div>
      <b>Specifies a duration in minutes.</b>
      <br />
      This duration starts after the <b>"Max duration of idle (min)"</b> is over.
      <br />
...
const SystemIdleActionPreference = {
  ...
  hint: (
    <div>
      Sets the <b>action</b> to perform with the instance with low CPU utilization (below the
...
const SystemLongPausedActionPreference = {
  ...
  hint: (
    <div>
      Sets the <b>action</b> to perform with the instance having the long paused state (longer then
      configured threshold).
    </div>
  ),
};
...
const SystemNotificationsExcludeInstanceTypesPreference = {
  ...
  hint: (
    <div>
      <b>Instances, listed here won't trigger the IDLE notification.</b>
      <br />
      The list shall be provided as a comma-separated string, you can also use the wildcards. E.g.
      m5.xlarge,*.large
    </div>
  ),
};
...
const SystemNotificationsExcludeParamsPreference = {
  ...
  hint: (
    <div>
      <b>
        Runs with parameters which matches any of the rules won't trigger the IDLE notification.
      </b>
      <br />
...
const SystemPodBandwidthLimitPreference = {
  ...
  hint: (
    <div>
      If the network bandwidth is more than specified <b>limit</b>, the configured <b>action</b>{' '}
      will be performed
    </div>
  ),
};
...
const SystemPodBandwidthActionPreference = {
  ...
  hint: (
    <div>
      Sets the <b>action</b> to perform with the instance having the high network bandwidth (above
...
const SystemPodBandwidthActionBackoffPeriodPreference = {
  ...
  hint: (
    <div>
      <b>Specifies a duration in minutes.</b>
      <br />
      This duration starts after the <b>high network bandwidth</b> event is registered.
      <br />
...
export {NotificationTypes, NotificationPreferences, Preferences, PreferencesSectionTitle};
