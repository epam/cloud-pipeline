...
import {Button, Form, Modal, Input, Row, Table, Select} from 'antd';
...
export default class CreateUserForm extends React.Component {
  ...
  render() {
    const modalFooter = this.props.pending ? (
      ...
      <Row>
        <Button id="create-user-form-cancel-button" onClick={this.props.onCancel}>
          Cancel
        </Button>
        <Button
    ...
    return (
      ...
      >
        <Form ref={this.formRef} className="create-user-form" layout="horizontal">
          ...
          <Row style={{marginTop: 15, paddingLeft: 2, marginBottom: 2}}>Assign group or role:</Row>
          ...
          <Row
            type="flex"
            style={{height: '30vh', overflow: 'auto', display: 'flex', flexDirection: 'column'}}
          >
