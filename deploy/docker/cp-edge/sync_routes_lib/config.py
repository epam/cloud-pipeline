...
NGINX_CUSTOM_DOMAIN_LOC_TMPL = f'include {{}}; # {NGINX_CUSTOM_DOMAIN_LOC_SUFFIX}'
...
NGINX_SRV_MODULE_TEMPLATE = f'/etc/nginx/endpoints-config/route.template{NGINX_CUSTOM_DOMAIN_CONFIG_EXT}'
