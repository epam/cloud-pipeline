...
import styles from './RunsSearch.module.css';
  ...
  parametersRenderer = (text) => {
    ...
    return (
      <div>
        ...
        <span className={classNames(styles.parametersTextHighlighted, 'cp-search-highlight-text')}>
          {highlighted}
        </span>
  ...
  render() {
    ...
    return (
      <Table
        ...
        rowKey="id"
        onRow={(run) => ({onClick: () => this.goToRun(run)})}
