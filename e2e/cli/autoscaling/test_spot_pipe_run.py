...
class TestSpotPipelineRun(object):
    ...
    @pipe_test
    def test_spot_pipeline_runs_and_finishes_successfully(self):
        pipeline_preference_should_be('cluster.spot', True)
        (run_id, _) = run_pipe(self.pipeline_name,
                               "-id", "23")
        TestSpotPipelineRun.run_id = run_id
        ...
        node_price_type_should_be(run_id, spot=True)
        ...
        TestSpotPipelineRun.node_name = node_name
