...
@inject(({allowedInstanceTypes, configurations, folders, pipelinesLibrary, preferences}, {onReloadTree, params}) => {
  return {
...
export default class DetachedConfiguration extends localization.LocalizedReactComponent {
  ...
  render () {
    ...
    const errors = [];
    if (this.props.allowedInstanceTypes && !this.props.allowedInstanceTypes.pending && this.props.allowedInstanceTypes.error) {
