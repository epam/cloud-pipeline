...
function rangeFilter({period, range, onChange, style}) {
  ...
  if (period === Period.custom) {
    return <RangePicker range={range} onChange={onCustomRangeChanged} style={style} />;
  }
  if (period === Period.day) {
    return <DayPicker value={start} onChange={onChangeDate} style={style} />;
  }
  return null;
}
