...
export default class CodeEditor extends React.Component {
  ...
  render() {
    return (
      <div className={this.props.className || codeEditorStyles.container} style={this.props.style}>
        <div
          className={
            this.props.readOnly ? codeEditorStyles.readOnlyEditor : codeEditorStyles.editor
          }
        >
