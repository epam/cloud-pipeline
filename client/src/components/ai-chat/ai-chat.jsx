...
export default class AIChat extends React.Component {
  ...
  scrollToMessage = (id) => {
    const index = [...this.answersContainerRef.children].findIndex(
  ...
  render() {
    ...
    return (
      ...
      >
                  ...
                  style={{
                    minHeight:
                      index === chat.messages.length - 1
                        ...
                        : 'auto',
                    marginBottom: index === chat.messages.length - 1 ? '40px' : 0,
                  }}
                  data-id={message.id}
                >
                  <Message
        ...
        <div
          className={classNames(styles.inputFieldArea, styles.chatArea, 'cp-panel-color', {
            [styles.dropShadow]: !this.scrolledDown,
          })}
        >
          <DownCircleOutlined
            className={classNames('cp-panel-background-color cp-primary', styles.downButton, {
              [styles.visible]: !this.isScrolling && !this.scrolledDown,
            })}
