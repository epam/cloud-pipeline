...
package com.epam.pipeline.external.datastorage.message;
...
public final class MessageConstants {
    ...
    public static final String ERROR_WRONG_ISSUE_ID_OR_COMMENT_ID = "error.wring.issue.id.or.comment.id";
