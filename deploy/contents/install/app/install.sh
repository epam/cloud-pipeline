...
if is_service_requested cp-api-db; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-api-db/cp-api-db-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-api-db/cp-api-db-svc.yaml
...
if is_service_requested cp-idp; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-idp/cp-idp-pod.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-idp/cp-idp-svc.yaml
...
if is_service_requested cp-heapster; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-heapster/cp-heapster-elk-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-heapster/cp-heapster-elk-svc.yaml
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-heapster/cp-heapster-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-heapster/cp-heapster-svc.yaml
...
if is_service_requested cp-api-srv; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-api-srv/cp-api-srv-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-api-srv/cp-api-srv-svc.yaml
...
if is_service_requested cp-docker-registry; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-docker-registry/cp-docker-registry-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-docker-registry/cp-docker-registry-svc.yaml
...
if is_service_requested cp-edge; then
    ...
    if is_install_requested; then   
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-edge/cp-edge-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-edge/cp-edge-svc.yaml
...
if is_service_requested cp-git; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-git/cp-git-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-git/cp-git-svc.yaml
...
if is_service_requested cp-git-sync; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-git-sync/cp-git-sync-pod.yaml
...
if is_service_requested cp-docker-comp; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-docker-comp/cp-docker-comp-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-docker-comp/cp-docker-comp-svc.yaml
...
if is_service_requested cp-clair; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-clair/cp-clair-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-clair/cp-clair-svc.yaml
...
if is_service_requested cp-notifier; then
    ...
    if is_install_requested; then
        ...
        if ! check_params_present "update_config" $CP_NOTIFIER_SMTP_PARAMETERS_LIST; then
            ...
            kubectl create -f $K8S_SPECS_HOME/cp-notifier/cp-notifier-pod.yaml
...
if is_service_requested cp-search; then
    ...
    if is_install_requested; then
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-search/cp-search-elk-dpl.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-search/cp-search-elk-svc.yaml
        ...
        kubectl create -f $K8S_SPECS_HOME/cp-search/cp-search-srv-pod.yaml
        kubectl create -f $K8S_SPECS_HOME/cp-search/cp-search-srv-svc.yaml
