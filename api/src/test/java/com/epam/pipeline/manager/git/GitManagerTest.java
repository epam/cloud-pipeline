...
public class GitManagerTest extends AbstractManagerTest {
    ...
    public void shouldDeleteFile() throws GitClientException {
        final Revision revision = new Revision("Initial commit", "", new Date(), "doesn't matter", "someauthor");
        final Pipeline pipeline = testingPipeline();
    ...
    public void getConfigFile() {
        ...
        final Revision revision = new Revision("Initial commit", "", new Date(), DRAFT_PREFIX + sha, "someauthor");
        pipeline.setCurrentVersion(revision);
    ...
    private Pipeline testingPipeline() {
        ...
        final Revision revision = new Revision(TEST_REVISION, "Initial commit", date, "somecommitsha", "someauthor");
        pipeline.setCurrentVersion(revision);
        return pipeline;
    }
