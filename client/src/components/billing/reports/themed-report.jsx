...
class ThemedReportConfiguration {
  ...
  get colors() {
    if (this.configuration) {
      return [this.current, this.previous, this.quota, ...this.otherColors];
    }
    return [colors.current, colors.previous, colors.quota, ...this.otherColors];
  }
...
class ThemedReport extends React.Component {
  ...
  render() {
    ...
    return <Provider reportThemes={this.configuration}>{children}</Provider>;
  }
}
