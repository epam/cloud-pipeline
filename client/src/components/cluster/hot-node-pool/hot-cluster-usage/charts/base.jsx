...
class BaseChart extends React.Component {
  ...
  chartRef = (ctx, props) => {
    if (ctx) {
      const {lineColor, textColor, period, periodType} = this.props;
      this.ctx = ctx;
      const {data, options = {}, type, plugins, units} = props || this.props;
        ...
        tooltips: {
          ...
          callbacks: {
            ...
            label: function (tooltipItem, data) {
              ...
              const {display: displayXLabel = true} = xLabel || {};
              ...
              if (!Number.isNaN(value)) {
                ...
                const {data: items = []} = data.datasets[datasetIndex] || {};
                const prev = items[dataIndex - 1];
                value =
                  prev !== undefined && !Number.isNaN(Number(prev))
