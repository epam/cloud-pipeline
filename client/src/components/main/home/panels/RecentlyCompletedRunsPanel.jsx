      ...
      content = [
        <Row key="runs" style={{flex: 1, overflowY: 'auto'}}>
          <CardsPanel
            ...
            actions={getRunActions(this.props, {
              pause: (run) =>
                this.confirm(`Are you sure you want to pause run ${run.podId}?`, 'PAUSE', () =>
                  this.pauseRun(run),
                ),
              resume: (run) =>
                this.confirm(`Are you sure you want to resume run ${run.podId}?`, 'RESUME', () =>
                  this.resumeRun(run),
                ),
              stop: (run) =>
                this.confirm(`Are you sure you want to stop run ${run.podId}?`, 'STOP', () =>
                  this.stopRun(run),
                ),
              run: this.reRun,
        ...
        <Row key="explore other" type="flex" justify="center" style={{margin: 10}}>
          <span
            style={{
              fontStyle: 'italic',
            }}
