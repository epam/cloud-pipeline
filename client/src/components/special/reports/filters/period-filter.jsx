...
import styles from './period-filter.module.css';

export default function DateFilter({filter, range, onChange = () => {}, periods, pending, style}) {
  ...
  return (
    <div style={{display: 'flex', alignItems: 'center'}}>
      <RangeFilter period={filter} range={range} onChange={onChange} style={style} />
      <Divider />
