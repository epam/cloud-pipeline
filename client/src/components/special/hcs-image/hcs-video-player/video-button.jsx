...
class VideoButton extends React.Component {
  ...
  render() {
    const {className, available, videoSource} = this.props;
    if (!videoSource || !available) {
      return null;
    }
    const IconComponent = videoSource.videoMode ? PictureOutlined : VideoCameraOutlined;
    return (
      <Button
        size="small"
        className={className}
      ...
      >
        <IconComponent className="cp-larger" />
      </Button>
    );
  }
}
