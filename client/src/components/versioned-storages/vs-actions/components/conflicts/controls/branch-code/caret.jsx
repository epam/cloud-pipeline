...
class Caret extends React.PureComponent {
  ...
  getPosition() {
    const {characterSize, marginLeft, marginTop, line, lineHeight, offset, text} = this.props;
  ...
  reportPositionChange = () => {
    ...
    const {characterSize, line, offset, text, lineHeight} = this.props;
    const correctedOffset = correctLineOffset(text, offset);
  ...
  render() {
    ...
    return (
      <svg
        ...
        className={classNames('cp-text', styles.caret, caretStyles.caret, {
