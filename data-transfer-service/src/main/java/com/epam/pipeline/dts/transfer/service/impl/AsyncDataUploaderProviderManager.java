...
public class AsyncDataUploaderProviderManager extends SyncDataUploaderProviderManager {

    @Autowired
    public AsyncDataUploaderProviderManager(final DataUploaderProvider dataUploaderProvider,
